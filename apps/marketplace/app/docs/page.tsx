...
export default function DocsPage() {
  ...
  const quickLinks = [
    { name: 'Dashboard', href: 'http://localhost:3001', description: 'Merchant dashboard' },
    { name: 'API Documentation', href: 'http://localhost:3000/api', description: 'REST API endpoints' },
    { name: 'Integration Guide', href: '/docs/integration', description: 'How to integrate the widget' },
  ];
