      ...
      <main id="main-content" className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10" role="main">
        ...
        <section className="text-center py-20 md:py-32">
          <div>
            ...
            <p className="text-xl md:text-2xl text-neutral-600 dark:text-neutral-300 mb-4 max-w-3xl mx-auto leading-relaxed">
        ...
        <section className="py-20 md:py-32">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            <div className="glass-strong p-6 md:p-8 rounded-xl hover:border-emerald-500/30 transition-all group">
            ...
            <div className="glass-strong p-6 md:p-8 rounded-xl hover:border-blue-500/30 transition-all group">
            ...
            <div className="glass-strong p-6 md:p-8 rounded-xl hover:border-purple-500/30 transition-all group">
        ...
        <section className="py-20 md:py-32">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {['Solana', 'Ethereum', 'Polygon', 'More Coming'].map((chain, idx) => (
              <div key={chain} className="glass p-6 rounded-xl text-center hover:border-emerald-500/30 transition-all group">
